        ...
        <section className="about" id="about" data-theme="light">
            <div className="about-container">
                ...
                <div className="about-left">
                    <img src ="/eve-about.jpeg" alt="Eve Guenda" className="about-photo"/>
                </div>
